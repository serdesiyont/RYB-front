    ...
    <div className="min-h-screen bg-background">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-40 h-40 mb-6 bg-gradient-to-br from-yellow-200 to-blue-200 rounded-full flex items-center justify-center">
                  <svg className="w-24 h-24" viewBox="0 0 100 100" fill="none">
                    ...
                    <path d="M35 50 Q50 70 65 50" stroke="#1E40AF" strokeWidth="3" fill="none"/>
                    <rect x="40" y="55" width="20" height="25" fill="#1E40AF"/>
                  </svg>
                </div>
                <h3 className="text-xl font-bold mb-2">Manage and edit your ratings</h3>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-40 h-40 mb-6 bg-gradient-to-br from-pink-200 to-purple-200 rounded-full flex items-center justify-center">
                  <svg className="w-24 h-24" viewBox="0 0 100 100" fill="none">
                    ...
                    <path d="M40 70 Q50 80 60 70" stroke="#1E40AF" strokeWidth="2"/>
                  </svg>
                </div>
                <h3 className="text-xl font-bold mb-2">Your ratings are always anonymous</h3>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-40 h-40 mb-6 bg-gradient-to-br from-cyan-200 to-yellow-200 rounded-full flex items-center justify-center">
                  <svg className="w-24 h-24" viewBox="0 0 100 100" fill="none">
                    <path d="M50 20 L60 50 L90 50 L65 70 L75 100 L50 80 L25 100 L35 70 L10 50 L40 50 Z" fill="#FFD700"/>
                  </svg>
                </div>
                <h3 className="text-xl font-bold mb-2">Like or dislike ratings</h3>
              </div>
            </div>
      ...
      <footer className="bg-gray-100 py-6 px-4 border-t">
        <div className="max-w-6xl mx-auto flex justify-center gap-4 text-xs text-gray-600">
          ...
          <a href="#" className="hover:underline">Site Guidelines</a>
          <a href="#" className="hover:underline">Terms & Conditions</a>
          <a href="#" className="hover:underline">Privacy Policy</a>
          <a href="#" className="hover:underline">Copyright Compliance Policy</a>
